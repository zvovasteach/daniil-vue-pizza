  ...
  >
    ...
    <div class="counter counter--orange ingredients__counter">
      <AppCounter
        ...
        @update:model-value="updateFillingCount(ingredient.value, $event)"
      />
    </div>
  </li>
</template>
...
<script setup>
import { MAX_FILLING_COUNT } from '@/common/constants.js';
...
const updateFillingCount = async (name, value) => {
...
const ingredientImage = computed(() => `url('${getPublicImage(props.ingredient.image)}')`);
</script>
...
.filling {
  ...
  &::before {
    ...
    background-image: v-bind(ingredientImage);
  }
